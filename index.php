...
<head>
	...
	<style type="text/css">
		...
		#left_panel label{
			...
			display: block;
			border-bottom: solid thin #ffff55;
			cursor: pointer;
			padding: 5px;
	...
	<div id="wrapper">
		<div id="left_panel">
			...
			<div style="padding: 10px;">
				<img id="profile_img" src="ui/images/user_male.jpg" style="width: 100px; height: 100px;">
				<br>
				<div id="username"></div>
				<br>
				<span style="font-size: 12px; opacity: 0.5;" id="email">example@example.com</span> 
				<br>
				<br>
				<br>
				<div>
					<label id="label_chats" for="radio_chat">Chat<img src="ui/icons/chat.png"></label>
					<label id="label_contacts" for="radio_contacts">Contact <img src="ui/icons/contact.png"></label>
...
<script>
var sent_audio = new Audio("ui/icons/message_sent.mp3");
var received_audio = new Audio("ui/icons/message_received.mp3");
...
<script>
//this performs the job for settings page	
